...
- 94e9e1a: Require Sanity 6.12 or later within major 6 (`^6.12.0`) and drop Sanity 5 support. Update integrations for Sanity UI 4 and Sanity icons 5. Require React and React DOM 19.2.4 or later within major 19. Sanity requires Node.js 22.12 or later.
