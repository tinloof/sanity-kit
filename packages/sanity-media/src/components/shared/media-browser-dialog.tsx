...
export function MediaBrowserDialog({
	...
	const {docTypes: referencingDocTypes} = useReferencingDocTypes({
		adapter,
		assetType,
	});
	...
	return (
		...
		>
			...
			>
				{/* Header section with toolbar and filters */}
				<Box
					paddingX={4}
					paddingTop={4}
					paddingBottom={3}
				...
				>
					<Stack space={3}>
						...
						<Flex gap={2} align="center" wrap="wrap">
								...
								<Flex gap={1} wrap="wrap" style={{flex: 1}}>
									...
									{advancedFilters.alt !== null && (
										<Flex
											...
											gap={1}
											onClick={() =>
												setAdvancedFilters((prev) => ({...prev, alt: null}))
											}
											style={{
												cursor: "pointer",
												padding: "2px 8px",
										...
										>
											<Text size={0}>
												{advancedFilters.alt ? "Has alt" : "Missing alt"}
											</Text>
											<CloseIcon style={{fontSize: 10}} />
										</Flex>
									)}
									{advancedFilters.title !== null && (
										<Flex
											...
											gap={1}
											onClick={() =>
												setAdvancedFilters((prev) => ({...prev, title: null}))
											}
											style={{
												cursor: "pointer",
												padding: "2px 8px",
										...
										>
											<Text size={0}>
												{advancedFilters.title ? "Has title" : "Missing title"}
											</Text>
											<CloseIcon style={{fontSize: 10}} />
										</Flex>
									)}
									{advancedFilters.caption !== null && (
										<Flex
											...
											gap={1}
											onClick={() =>
												setAdvancedFilters((prev) => ({...prev, caption: null}))
											}
											style={{
												cursor: "pointer",
												padding: "2px 8px",
							...
							{!showFilters && (
								<Box style={{flex: activeFilterCount > 0 ? 0 : 1}} />
							)}
