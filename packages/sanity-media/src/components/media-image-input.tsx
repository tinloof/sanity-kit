  ...
  if (value?.asset?._ref && assetPreview) {
    return (
      <Stack space={3}>
          ...
          <Stack space={3}>
            {assetPreview.url && (
              ...
              >
                <img
                  ...
                  alt={value.alt || assetPreview.originalFilename}
                  style={{
                    width: "100%",
                    height: "auto",
                    objectFit: "contain",
            ...
            <Stack space={2}>
              ...
              {assetPreview.metadata?.dimensions && (
                <Text size={0} muted>
                  {assetPreview.metadata.dimensions.width} ×{" "}
                  {assetPreview.metadata.dimensions.height}
                </Text>
              )}
            </Stack>
          </Stack>
        ...
        <TextInput
          value={value.alt || ""}
          onChange={(e) => onChange(set(e.currentTarget.value, ["alt"]))}
