...
/** Subset of file asset fields needed for preview display */
type FileAssetPreview = {
	_id: string;
...
export function MediaFileInput(props: ObjectInputProps) {
	...
	const [assetPreview, setAssetPreview] = useState<FileAssetPreview | null>(
		null,
	);
	...
	const loadAsset = useCallback(async () => {
		if (value?.asset?._ref) {
			try {
				...
				setAssetPreview(asset ? (asset as unknown as FileAssetPreview) : null);
			} catch (err) {
	...
	const handleFileSelect = useCallback(
		...
		[ready, credentials, adapter, client, onChange, value, loadAsset],
	);
